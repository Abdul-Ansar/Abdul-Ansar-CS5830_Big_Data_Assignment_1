# -*- coding: utf-8 -*-
"""CS5830_Assignment_1.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1UTYeMHA5Ch_VgrmcLGtildFH1zmBYD1T
"""
...
# load the dataset using keras library call
...
def rotate(image, angle):
    ...
    for i in range(image.shape[0]):
        for j in range(image.shape[1]):
            ...
            translated_coords = np.array([i, j]) - center
...
def generate_dataset(dataset, oversample_rate):
    oversample_rate = max(2, oversample_rate)
    to_generate_count = int(dataset.shape[0] * (oversample_rate - 1.0))
